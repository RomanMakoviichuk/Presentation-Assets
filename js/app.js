(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) new core(".swiper", {
            ...
            navigation: {
                prevEl: ".swiper__buttons_next",
                nextEl: ".swiper__buttons_prev"
            },
            on: {}
        });
    }
    ...
    document.addEventListener("DOMContentLoaded", (function() {
        ...
        async function formSend(e) {
            ...
            if (0 === error) {
                ...
                if (response.ok) {
                    await response.json();
                    modules_flsModules.popup.open("#popup_send");
                    form.reset();
            ...
            } else modules_flsModules.popup.open("#popup");
        }
        ...
        var onPhoneInput = function(e) {
            var input = e.target, inputNumbersValue = getInputNumbersValue(input), selectionStart = input.selectionStart;
